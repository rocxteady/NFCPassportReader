...
public class PACEHandler {
    ...
    public func doPACE( mrzKey : String ) async throws {
        ...
        Log.info( "Performing PACE with \(self.paceInfo.getProtocolOIDString())" )
        ...
        Log.debug("paceOID - \(self.paceOID)" )
        Log.debug("parameterSpec - \(self.parameterSpec)" )
        Log.debug("mappingType - \(self.mappingType!.description())" )
        Log.debug("agreementAlg - \(self.agreementAlg)" )
        Log.debug("cipherAlg - \(self.cipherAlg)" )
        Log.debug("digestAlg - \(self.digestAlg)" )
        Log.debug("keyLength - \(self.keyLength)" )
        Log.debug("keyLength - \(mrzKey)" )
        Log.debug("paceKey - \(binToHexRep(self.paceKey, asArray:true))" )
